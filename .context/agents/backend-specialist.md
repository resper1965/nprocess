...
- [`BPMNService`](backend/app/services/process/bpmn.py#L44) (class)
- [`KnowledgeService`](backend/app/services/knowledge/service.py#L22) (class)
- [`IngestionService`](backend/app/services/ingestion/service.py#L20) (class)
- [`DocumentGeneratorService`](backend/app/services/documents/generator.py#L38) (class)
- [`ComplianceAuditService`](backend/app/services/compliance/audit.py#L48) (class)
- [`GeminiService`](backend/app/services/ai/gemini.py#L20) (class)
- [`EmbeddingService`](backend/app/services/ai/embedding.py#L18) (class)
