...
- [`TenantBase`](backend/app/schemas/system.py#L7) (class)
- [`TenantCreate`](backend/app/schemas/system.py#L11) (class)
- [`TenantResponse`](backend/app/schemas/system.py#L14) (class)
- [`ApiKeyCreate`](backend/app/schemas/system.py#L21) (class)
- [`ApiKeyResponse`](backend/app/schemas/system.py#L25) (class)
- [`SystemUserResponse`](backend/app/schemas/system.py#L35) (class)
- [`GenerateBPMNRequest`](backend/app/schemas/process.py#L12) (class)
- [`GenerateBPMNResponse`](backend/app/schemas/process.py#L27) (class)
- [`ProcessJob`](backend/app/schemas/process.py#L37) (class)
- [`IngestRequest`](backend/app/schemas/knowledge.py#L13) (class)
- [`IngestResponse`](backend/app/schemas/knowledge.py#L31) (class)
- [`SearchRequest`](backend/app/schemas/knowledge.py#L42) (class)
- [`SearchResult`](backend/app/schemas/knowledge.py#L53) (class)
- [`SearchResponse`](backend/app/schemas/knowledge.py#L63) (class)
- [`DocumentSummary`](backend/app/schemas/knowledge.py#L71) (class)
