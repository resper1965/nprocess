              ...
              <CardContent>
                <div className="bg-gray-900 dark:bg-gray-950 rounded-lg p-6 font-mono text-sm text-gray-300 overflow-x-auto mb-6">
                  ...
                  <div className="mb-4">
                    ...
                    <span className="text-blue-400">https://nprocess-api-prod-fur76izi3a-uc.a.run.app/v1/analyze</span>
                  </div>
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <a 
                    href="https://nprocess-api-prod-fur76izi3a-uc.a.run.app/docs" 
                    target="_blank" 
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li>
                  <a href="https://nprocess-api-prod-fur76izi3a-uc.a.run.app/docs" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                    API Documentation
                  </a>
                </li>
