...
const sidebarVariants = cva(
  'group/sidebar fixed inset-y-0 left-0 z-20 flex-col gap-4 border-r border-slate-800/50 bg-slate-950/95 backdrop-blur-sm p-6 transition-all duration-300 ease-in-out',
  {
    variants: {
      state: {
        expanded: 'w-64',
